...
class SpeechPage extends Component {
  ...
  handleSubmit() {
    const apiUrl = 'https://political-speech-generator.onrender.com/generate_speech'; // Replace with your API endpoint
  ...
  handleTranslate() {
    ...
    const apiUrl = 'https://political-speech-generator.onrender.com/translate'; // Replace with your API endpoint
